...
import { executeAdvancedTrade, fetchPortfolioBalance, fetchMarketData } from './tools/12d7aaea-0aca-4951-95d5-19693216eb38.mjs';
...
Execute trades that will win the $20,000 prize pool! WAGMI! \u{1F680}`;
...
console.log("\u{1F680} WAGMI Trading Agent Starting...");
console.log("\u{1F4CA} Dashboard available at: http://localhost:4111");
console.log("\u{1F916} Agent chat: http://localhost:4111/agents/wagmiAgent/chat");
console.log("\u26A1 Workflow: http://localhost:4111/workflows/wagmi-trading-workflow");
console.log("\u{1F4B0} Ready to compete for $20,000 prize pool!");
