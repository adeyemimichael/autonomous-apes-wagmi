...
exports.wagmiAgent = void 0;
const openai_1 = require("@ai-sdk/openai");
const agent_1 = require("@mastra/core/agent");
const market_data_1 = require("../tools/market-data");
exports.wagmiAgent = new agent_1.Agent({
...
Remember: You're competing for $20,000 in prizes. Be aggressive but smart. WAGMI!`,
    ...
    tools: {
        fetchMarketData: market_data_1.fetchMarketData,
        fetchPortfolioBalance: market_data_1.fetchPortfolioBalance,
        executeAdvancedTrade: market_data_1.executeAdvancedTrade
    },
});
//# sourceMappingURL=wagmi-agent.js.map